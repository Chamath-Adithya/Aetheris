...
export function getLanguage() {
  // VERITAS_LANG takes priority to avoid conflict with Linux system LANGUAGE variable
  const lang = (process.env.VERITAS_LANG || process.env.LANGUAGE || process.env.LANG || DEFAULT_LOCALE)
    .toLowerCase()
    .slice(0, 2);
