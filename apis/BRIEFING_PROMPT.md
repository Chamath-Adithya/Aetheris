# Veritas Intelligence Briefing Protocol
...
Run the full Veritas sweep:

```bash
cd C:/Users/ishan/Documents/Aetheris && node apis/briefing.mjs 2>&1
```
