#!/usr/bin/env node
// Veritas Diagnostic — run this to find out why server.mjs fails silently
// Usage: node diag.mjs

console.log('=== VERITAS DIAGNOSTICS ===\n');
...
try {
  ...
  if (err.code === 'EADDRINUSE') {
    ...
    console.error('   A previous Veritas instance may still be running.');
